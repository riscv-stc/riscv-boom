          ...
          tileParams = BoomTileParams(
            core = BoomCoreParams(
              ...
              issueParams = Seq(
                ...
                IssueParams(issueWidth=4, numEntries=48, iqType=IQT_INT.litValue, dispatchWidth=4),
                IssueParams(issueWidth=1, numEntries=16, iqType=IQT_FP.litValue , dispatchWidth=4),
                IssueParams(issueWidth=1, numEntries=16, iqType=IQT_VEC.litValue, dispatchWidth=4),
                IssueParams(issueWidth=1, numEntries=16, iqType=IQT_MAT.litValue, dispatchWidth=4)),
              numIntPhysRegisters = 360,
              numFpPhysRegisters = 48,
              numLdqEntries = 60,
              numStqEntries = 60,
              numVLdqEntries = 256,
              ...
              maxBrCount = 16,
              maxVconfigCount = 16,
              vcq = VcqParameters(nEntries=16),
              numFetchBufferEntries = 48,
              ftq = FtqParameters(nEntries=80),
              nPerfCounters = 29,
              ...
              eLen = 64,
              vMemDataBits = 64,
              numVecPhysRegisters = 97,
              useMatrix = true,
              rLen = 128,
              mLen = 1024, // rLen * 8
              numMatTrRegisters = 36,
              numMatAccRegisters = 18,
