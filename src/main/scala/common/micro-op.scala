...
//Matrix Extension
  ...
  val uopMSETTSIDXI_enum   = Value
  val uopMSETTSIDXI        = uopMSETTSIDXI_enum.id.U(UOPC_SZ.W)
  ...
  val uopMSUB             = uopMSUB_enum.id.U(UOPC_SZ.W)
  val uopMWSUB_enum       = Value
  val uopMWSUB            = uopMWSUB_enum.id.U(UOPC_SZ.W)
  val uopMQSUB_enum       = Value
  val uopMQSUB            = uopMQSUB_enum.id.U(UOPC_SZ.W)
  val uopMRSUB_enum       = Value
  val uopMRSUB            = uopMRSUB_enum.id.U(UOPC_SZ.W)
  val uopMWRSUB_enum      = Value
