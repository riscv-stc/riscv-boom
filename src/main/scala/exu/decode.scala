...
object VectorIntDecode extends DecodeConstants
{
  val table: Array[(BitPat, List[BitPat])] = Array(
   ...
   ,VZEXT_VF2  ->List(Y, N, X, uopVEXT2,   IQT_VEC ,FU_ALU ,RT_VEC , RT_X  , RT_VNU, N, IS_X, N, N, N, N, N, M_X, U_0, N, N, N, N, N, CSR.N, Y, Y, Y, DC2)
   ,VSEXT_VF2  ->List(Y, N, X, uopVEXT2,   IQT_VEC ,FU_ALU ,RT_VEC , RT_X  , RT_VN , N, IS_X, N, N, N, N, N, M_X, U_0, N, N, N, N, N, CSR.N, Y, Y, Y, DC2)
   ,VZEXT_VF4  ->List(Y, N, X, uopVEXT4,   IQT_VEC ,FU_ALU ,RT_VEC , RT_X  , RT_VNU, N, IS_X, N, N, N, N, N, M_X, U_0, N, N, N, N, N, CSR.N, Y, Y, Y, DC2)
   ,VSEXT_VF4  ->List(Y, N, X, uopVEXT4,   IQT_VEC ,FU_ALU ,RT_VEC , RT_X  , RT_VN , N, IS_X, N, N, N, N, N, M_X, U_0, N, N, N, N, N, CSR.N, Y, Y, Y, DC2)
   ,VZEXT_VF8  ->List(Y, N, X, uopVEXT8,   IQT_VEC ,FU_ALU ,RT_VEC , RT_X  , RT_VNU, N, IS_X, N, N, N, N, N, M_X, U_0, N, N, N, N, N, CSR.N, Y, Y, Y, DC2)
   ,VSEXT_VF8  ->List(Y, N, X, uopVEXT8,   IQT_VEC ,FU_ALU ,RT_VEC , RT_X  , RT_VN , N, IS_X, N, N, N, N, N, M_X, U_0, N, N, N, N, N, CSR.N, Y, Y, Y, DC2)
...
object VectorMaskDecode extends DecodeConstants
{
  val table: Array[(BitPat, List[BitPat])] = Array (
   ...
   ,VPOPC_M    ->List(Y, N, X, uopVPOPC,   IQT_VEC ,FU_VMASKU,RT_FIX, RT_X, RT_VEC, N, IS_X, N, N, N, N, N, M_X, U_0, N, N, N, N, N, CSR.N, Y, Y, Y, DC2)
   ,VFIRST_M   ->List(Y, N, X, uopVFIRST,  IQT_VEC ,FU_VMASKU,RT_FIX, RT_X, RT_VEC, N, IS_X, N, N, N, N, N, M_X, U_0, N, N, N, N, N, CSR.N, Y, Y, Y, DC2)
   ,VMSBF_M    ->List(Y, N, X, uopVMSBF,   IQT_VEC ,FU_VMASKU,RT_VEC, RT_X, RT_VEC, N, IS_X, N, N, N, N, N, M_X, U_0, N, N, N, N, N, CSR.N, Y, Y, Y, DC2)
   ,VMSIF_M    ->List(Y, N, X, uopVMSIF,   IQT_VEC ,FU_VMASKU,RT_VEC, RT_X, RT_VEC, N, IS_X, N, N, N, N, N, M_X, U_0, N, N, N, N, N, CSR.N, Y, Y, Y, DC2)
...
object VectorPermDecode extends DecodeConstants
{
  val table: Array[(BitPat, List[BitPat])] = Array (
   ...
   ,VSLIDEUP_VX    ->List(Y, N, X, uopVSLIDEUP,    IQT_IVEC,FU_ALU ,RT_VEC, RT_FIXU,RT_VEC, N, IS_X, N, N, N, N, N, M_X, U_0, N, N, N, N, N, CSR.N, Y, Y, Y, DC2)
   ,VSLIDEUP_VI    ->List(Y, N, X, uopVSLIDEUP,    IQT_VEC ,FU_ALU ,RT_VEC, RT_VIU, RT_VEC, N, IS_X, N, N, N, N, N, M_X, U_0, N, N, N, N, N, CSR.N, Y, Y, Y, DC2)
   ...
   ,VFSLIDE1UP_VF  ->List(Y, Y, X, uopVSLIDE1UP,   IQT_FVEC,FU_FPU ,RT_VEC, RT_FLT, RT_VEC, N, IS_X, N, N, N, N, N, M_X, U_0, N, N, N, N, N, CSR.N, Y, Y, Y, DC2)
   ...
   ,VFSLIDE1DOWN_VF->List(Y, Y, X, uopVSLIDE1DOWN, IQT_FVEC,FU_FPU ,RT_VEC, RT_FLT, RT_VEC, N, IS_X, N, N, N, N, N, M_X, U_0, N, N, N, N, N, CSR.N, Y, Y, Y, DC2)
   ...
   ,VRGATHEREI16_VV->List(Y, N, X, uopVRGATHEREI16,IQT_VEC ,FU_ALU ,RT_VEC, RT_VU , RT_VEC, N, IS_X, N, N, N, N, N, M_X, U_0, N, N, N, N, N, CSR.N, Y, Y, Y, DC2)
   ,VCOMPRESS_VM   ->List(Y, N, X, uopVCOMPRESS,   IQT_VEC ,FU_ALU ,RT_VU , RT_VU , RT_VU , N, IS_X, N, N, N, N, N, M_X, U_0, N, N, N, N, N, CSR.N, Y, Y, Y, DC2)
